-- ============================================================
-- Family Hub — 模块 B：突触激活 表结构
-- 版本：1.0.0
-- 日期：2026-04-16
-- ============================================================

-- -----------------------------------------------------------
-- 1. task_template（突触模板）
-- 前额叶创建的可复用突触模板，定义突触的"是什么"和"什么时候适用"
-- -----------------------------------------------------------
